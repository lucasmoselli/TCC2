    ...
    .then(data => {
      if (data) {
        ...
        for (var i = 0; i < 24; i++) {
          ...
          temperatura.push(data[i].tp_sfc_so10MD_Media)
          velocidadeVento.push(data[i].ws_avg_so10MD_Media)
          difuso.push(data[i].dif_avg_so01MD_Media)
          direto.push(data[i].dir_avg_so01MD_Media)
          lw.push(data[i].lw_avg_so01MD_Media)
          paralelo.push(data[i].par_avg_so01MD_Media)
