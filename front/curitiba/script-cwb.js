    ...
    .then(data => {
      if (data) {
        ...
        for (var i = 0; i < 24; i++) {
          ...
          global.push(data[i].glo_avg_so01CT_Media)
          inclinado.push(data[i].tilt_avg_so01CT_Media)
          temperatura.push(data[i].tp_sfc_so10CT_Media)
          velocidadeVento.push(data[i].ws_avg_so10CT_Media)
          difuso.push(data[i].dif_avg_so01CT_Media)
          direto.push(data[i].dir_avg_so01CT_Media)
          lw.push(data[i].lw_avg_so01CT_Media)
          paralelo.push(data[i].par_avg_so01CT_Media)
          chuva.push(data[i].rain_so10CT_Soma)
        }
