    ...
    .then(data => {
      if (data) {
        ...
        for (var i = 0; i < 24; i++) {
          ...
          global.push(data[i].glo_avg_ep01CT_Media)
          inclinado.push(data[i].tilt_avg_ep01CT_Media)
          temperatura.push(data[i].tp_sfc_ep10CT_Media)
          velocidadeVento.push(data[i].ws_avg_ep10CT_Media
          )
        }
